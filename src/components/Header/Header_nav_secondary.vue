<template>
    <nav class="text-sm-right text-center secNavContainer">
        <div class="searchContainer">
            <div class="textInputContainerWIcon">
                <input :class="visible ? null : 'collapsed'"
                       ...
                       @blur="closeSearch"
                       v-on:keyup="Search" class="textInput" type="text" autocomplete="off" placeholder="Busca" id="search">
        ...
        <div class="cartContainer interactible">
            <svg class="cartIcon" v-b-toggle.collapse-2 width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Header_nav_cart></Header_nav_cart>
    </nav>
</template>
